  ...
  return (
    <div className="group relative">
      <div
        ...
        className="fixed rounded-full bottom-16 right-4 sm:bottom-16 md:bottom-20 lg:bottom-6 p-3 sm:right-6 z-50 bg-green-500 hover:bg-green-600 shadow-2xl cursor-pointer transition-all duration-300 hover:scale-110"
      >
        <svg
      ...
      <div className="fixed bottom-20 right-16 sm:bottom-12 sm:right-20 md:bottom-14 lg:bottom-10 z-40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <div className="bg-green-500 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap shadow-lg">
          Chat on WhatsApp!
          <div className="absolute top-1/2 -right-1 transform -translate-y-1/2 w-2 h-2 bg-green-500 rotate-45"></div>
        </div>
      </div>
    </div>
  );
